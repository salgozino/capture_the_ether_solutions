...
async function main() {
  ...
  const atacanteSC = await Atacante.attach("0xEB60294136856C90096f699e17a5dd87c227a076");
  ...
  console.log("Trying to attack")
    try {
      ...
      console.log("Attack wasn't reverted")
    } catch {
  ...
  console.log("Challenge complete?", succesfull)
}
